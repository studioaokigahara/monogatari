...
from .izanagi import Oni, Izanagi, IzanagiZero
...
def get_megatron_optimizer(
    ...
    elif args.optimizer == "izanagi":
        optimizer = Izanagi(
            param_groups,
            lr=args.lr,
            weight_decay=args.weight_decay,
            beta=args.izanagi_beta,
            momentum=args.izanagi_momentum,
            eps=args.izanagi_eps,
        )
        optimizer = Oni(optimizer)
    elif args.optimizer == "izanagizero":
        optimizer = IzanagiZero(
            param_groups,
            lr=args.lr,
            weight_decay=args.weight_decay,
            beta=args.izanagi_beta,
